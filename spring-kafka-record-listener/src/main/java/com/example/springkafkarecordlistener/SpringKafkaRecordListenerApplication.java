...
public class SpringKafkaRecordListenerApplication {
    public static Logger logger = LoggerFactory.getLogger(SpringKafkaRecordListenerApplication.class);

    public static void main(String[] args) {
        SpringApplication.run(SpringKafkaRecordListenerApplication.class, args);
    }
    ...
    public void topicWithPropertiesListener(String messageValue) {
        logger.info(messageValue);
    }
